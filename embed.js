(function () {
  ...
  // ponytail: host pages sometimes place this <script> tag before the container div (no
  // defer/async), so the container may not exist in the DOM yet when we run. Retry once the
  // page finishes parsing instead of silently giving up.
